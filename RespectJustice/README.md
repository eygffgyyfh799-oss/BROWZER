...
- **مصدر الرصيد (`Finance.Provider = 'auto'`):**
  - إذا RespectBanking شغّال (النسخة المعدّلة)، يستخدم حساب القطاع الحقيقي فيه مباشرة.
...
## 🏦 RespectBanking
> **لازم تستخدم نسخة RespectBanking المعدّلة** (مرفقة مع هالإصدار): فيها الربط جاهز، ومشالة منها ثغرة خطيرة.

- **وين تروح الفلوس المسحوبة** (سحب أو غرامة): `WithdrawTo = 'officer'` (لحسابك)، أو `'society'`، أو `'none'`.
- **تجميد حساب الموقوف (يشتغل تلقائي):**
  - الموقوف ما يقدر يسحب أو يحوّل أو يدفع فواتير أو أي شي من البنك، ويطلع له السبب.
  - الكاش والإيداع عادي.
  - الغرامات وسحب العدل تمشي حتى لو الحساب مجمّد.
  - أدوات لسكربتات ثانية:
  ```lua
  ...
  ```
- **مالية القطاعات:** تقرا وتسحب وتودع من **حساب الشرطة والصحة الحقيقي** في RespectBanking، وهو نفس الحساب اللي في البنك.
- **اللاعب غير المتصل:** السحب والغرامة يتسجلون في جدول البنك بعد، عشان ما يرجع المبلغ لما يدخل.
